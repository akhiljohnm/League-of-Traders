...
* **The Bank:** We manage virtual balances in our own database (Supabase). Every player gets $500 Game Tokens.
...
2. **Alpha Tax:** Winning players (Balance > $500) keep 80% of their net profit + their $500 buy-in. The other 20% goes to the "Safety Net Fund."
3. **The Bailout:** Losing players (Balance < $500) split the Safety Net evenly, strictly capped so their final balance never exceeds their original $500 buy-in.
